...
function FormularioDist({info}) {
  ...
  const handleSendWS = () => {
    mensaje = `(Formulario Distribuidor)/Empresa:${nombre_empresa.current.value}; 
    ...
    <>
        <section>
            <div className='container mx-auto px-4 lg:px-32'>
              <h3 className='flex justify-center text-lg font-semibold lg:text-2xl'>{info.tituloFormularioDistribuidor}</h3>
