            ...
            <div className='container mx-auto px-4' id='categorias' onClick={handleClick} style={{width:'-webkit-fill-available'}}>
              ...
              <div className='grid gab-2 grid-cols-2 space-x-3 md:h-48 lg:h-72 xl:h-96'>
                  ...
                  <Card id='Categorias 3' className="carta py-12 bg-no-repeat bg-cover bg-center bg-[url('paneles-portatiles.jpg')] bg-gray-400 bg-blend-multiply shadow-xl" style={{backgroundImage:"url('paneles-portatiles.jpg')"}}>
                    <h5 id='Categorias 3' className="text-center text-xl font-bold tracking-tight text-white md:text-3xl lg:text-4xl">
              ...
              <Card id='Categorias 4' className="carta w-full py-12 bg-cover bg-center bg-[url('respaldo-familia.jpg')] bg-gray-400 bg-blend-multiply shadow-xl md:h-48 lg:h-72 xl:h-96" style={{backgroundImage:"url('respaldo-familia.jpg')"}}>
                <h5 id='Categorias 4' className="text-center text-2xl font-bold tracking-tight text-white md:text-3xl lg:text-4xl">
                  Categorias 4
                </h5>
              </Card>
