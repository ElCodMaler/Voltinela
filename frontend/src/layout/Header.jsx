    ...
    <>
        <header>
          <Navbar className={`${visible ? 'bgNav bg-white/50' : 'bg-transparent'} fixed top-0 left-0 right-0 z-30 mx-4 my-4 px-6 py-0 rounded-full md:mx-16 md:my-6 lg:px-8 lg:py-2 lg:mx-20 lg:mt-12`} fluid rounded>
            <Navbar.Brand href="#">
              <Link to={'/Voltinela/'}>
                <img src="../../public/voltinela-logo-blanco.png" className="mr-3 h-4 sm:h-8 lg:h-10" alt="Logo" />
              </Link>
            </Navbar.Brand>
          ...
          <div id="drawer-navigation" className={`${close ? 'transform-none' : ''} fixed top-0 left-0 z-40 w-full h-screen p-8 overflow-y-auto transition-transform translate-x-full lg:p-16`} tabindex="-1" aria-labelledby="drawer-navigation-label" style={{backgroundColor:'#00000082',backdropFilter: "blur(4px)"}}>
              <img src="../../public/voltinela-logo-blanco.png" className="mr-3 h-6 sm:h-9 lg:h-16" alt="Logo" />
